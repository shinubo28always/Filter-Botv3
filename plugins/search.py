...
def search_handler(message):
    ...
    if message.chat.type == "private":
        ...
        # Agar group mein msg aaya hai, toh ensure karein ki group saved hai
    ...
    if best_matches[0][1] >= 95:
        ...
        # Groups mein reply karke suggestions dena
...
def send_final_result(message, data, r_mid):
    ...
    try:
        ...
        print(f"Result Copy Error: {e}")
        bot.send_message(message.chat.id, "❌ Post not found in DB Channel.", reply_to_message_id=r_mid)
